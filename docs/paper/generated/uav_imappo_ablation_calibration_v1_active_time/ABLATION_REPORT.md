...
> 自动生成；证据等级：`pilot`。 本结果仅验证管线，不作效果推断。
...
|---|---|---|---:|---:|---:|---:|:---:|
| action_mask | no_mask − imappo_full | collision_rate | 0.0010 | [0.0010, 0.0010] | 1.000000 | 1.000000 | no |
| action_mask | no_mask − imappo_full | task_completion | 0.0645 | [0.0645, 0.0645] | 1.000000 | 1.000000 | no |
...
| cbf_safety_filter | no_cbf − imappo_full | collision_rate | 0.0150 | [0.0150, 0.0150] | 1.000000 | 1.000000 | no |
| cbf_safety_filter | no_cbf − imappo_full | task_completion | 0.0002 | [0.0002, 0.0002] | 1.000000 | 1.000000 | no |
| nli_prototype_gate | no_nli_gate − imappo_full | collision_rate | 0.0000 | [0.0000, 0.0000] | 1.000000 | 1.000000 | no |
| nli_prototype_gate | no_nli_gate − imappo_full | task_completion | 0.0008 | [0.0008, 0.0008] | 1.000000 | 1.000000 | no |
| learned_residual | prior_only − imappo_full | collision_rate | 0.0000 | [0.0000, 0.0000] | 1.000000 | 1.000000 | no |
| learned_residual | prior_only − imappo_full | task_completion | 0.0002 | [0.0002, 0.0002] | 1.000000 | 1.000000 | no |
| semantic_rule_prior | no_profile_prior − imappo_full | collision_rate | 0.0040 | [0.0040, 0.0040] | 1.000000 | 1.000000 | no |
| semantic_rule_prior | no_profile_prior − imappo_full | task_completion | 0.0095 | [0.0095, 0.0095] | 1.000000 | 1.000000 | no |
...
|---|---:|---:|---:|---:|
| imappo_full | 7 | 86.86 | 804.4 | 2 |
| no_mask | 7 | 52.80 | 812.2 | 2 |
| no_attention | 7 | 53.27 | 812.2 | 2 |
| no_intent_reward | 7 | 49.60 | 812.2 | 2 |
| no_cbf | 7 | 50.90 | 812.2 | 2 |
| no_nli_gate | 7 | 54.20 | 812.2 | 2 |
| prior_only | 7 | 54.83 | 812.2 | 2 |
| no_profile_prior | 7 | 50.07 | 812.2 | 2 |
| identity_oracle | 7 | 48.20 | 660.4 | 2 |
| no_intent | 7 | 44.89 | 660.3 | 2 |
