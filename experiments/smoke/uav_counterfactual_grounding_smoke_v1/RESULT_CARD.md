# Result Card: uav_counterfactual_grounding_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `1`
- Primary objective: Causally audit text-to-profile-to-control grounding with minimally contrastive objective instructions.
