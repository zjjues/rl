# Result Card: uav_semantic_residual_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `2`
- Primary objective: Verify that semantic residual I-MAPPO trains from the shared rule prior and isolate prior versus semantic-conditioning effects.

## Variants

- `semantic_residual`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `nonsemantic_residual`: representation=`none`, algorithm=`mappo`
- `semantic_direct`: representation=`objective_grounded_semantic`, algorithm=`imappo`
