# Result Card: vmas_navigation_architecture_v1_smoke

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `3`
- Primary objective: Pipeline validation on VMAS navigation; no language, UAV objective, action-mask, safety-filter, or preference claim.
