# Result Card: uav_counterfactual_grounding_smoke_v9_strict_counterfactual
...
- `contrastive_anchor_prior`: representation=`objective_grounded_semantic`, algorithm=`imappo`
