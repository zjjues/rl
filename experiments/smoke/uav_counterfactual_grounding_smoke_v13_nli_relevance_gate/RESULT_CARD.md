# Result Card: uav_counterfactual_grounding_smoke_v13_nli_relevance_gate
...
- `prototype_ridge_prior`: representation=`objective_grounded_semantic`, algorithm=`imappo`
