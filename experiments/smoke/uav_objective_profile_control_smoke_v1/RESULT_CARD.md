# Result Card: uav_objective_profile_control_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `1`
- Primary objective: Verify continuous seven-objective text-profile modulation against posture-only, neutral, and oracle rule controls.

## Variants

- `continuous_profile_residual`: representation=`objective_grounded_semantic`, algorithm=`imappo`
