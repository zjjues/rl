# Result Card: uav_disturbance_residual_learning_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `1`
- Primary objective: Test whether learned residual feedback improves a frozen semantic model-based prior under wind, sensor noise, latency, and communication loss.

## Variants

- `prototype_disturbance_residual`: representation=`objective_grounded_semantic`, algorithm=`imappo`
...
- `nonsemantic_disturbance_residual`: representation=`none`, algorithm=`mappo`
