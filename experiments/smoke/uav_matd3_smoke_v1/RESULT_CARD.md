# Result Card: uav_matd3_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `2`
- Primary objective: Exercise true MATD3 replay, twin critics, target smoothing, delayed actor updates, and hidden-intent evaluation.
