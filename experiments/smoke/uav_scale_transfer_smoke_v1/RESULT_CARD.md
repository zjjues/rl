# Result Card: uav_scale_transfer_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `2`
- Primary objective: Verify zero-shot decentralized execution from four training UAVs to 8, 12, and 16 UAVs with fixed three-neighbor observations.
