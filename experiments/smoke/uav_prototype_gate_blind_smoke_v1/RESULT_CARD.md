# Result Card: uav_prototype_gate_blind_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `1`
- Primary objective: Evaluate prototype-class NLI gating on v6 wording frozen before observing outputs.
...
- Suite: `uav_intent_generalization_v6_prototype_gate_blind`
- Training intents: `19`
