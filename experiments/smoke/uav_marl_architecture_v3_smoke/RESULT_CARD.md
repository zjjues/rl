# Result Card: uav_marl_architecture_v3_smoke

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `3`
- Primary objective: Pipeline validation for corrected UAV MARL baselines including independent-actor sequential HAPPO.
