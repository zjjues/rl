# Result Card: uav_residual_learning_sensitivity_smoke_v1

- Evidence level: `smoke`
- Seeds: `7`
- Evaluation episodes per seed/tier: `1`
- Primary objective: Diagnose whether longer PPO training, residual scale, or potential shaping creates measurable learned corrections beyond the frozen prototype semantic prior.

## Variants

- `prototype_residual_025`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `prototype_residual_050`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `prototype_residual_050_no_potential`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `prototype_prior`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `nonsemantic_residual_050`: representation=`none`, algorithm=`mappo`
