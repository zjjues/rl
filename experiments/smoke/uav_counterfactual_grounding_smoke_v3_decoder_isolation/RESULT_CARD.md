# Result Card: uav_counterfactual_grounding_smoke_v3_decoder_isolation
...
- `calibrated_anchor_prior`: representation=`objective_grounded_semantic`, algorithm=`imappo`
