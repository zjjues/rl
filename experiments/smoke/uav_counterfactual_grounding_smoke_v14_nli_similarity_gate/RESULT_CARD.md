# Result Card: uav_counterfactual_grounding_smoke_v14_nli_similarity_gate
...
- `nli_similarity_gated_prior`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `nli_relevance_gated_prior`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `nli_entailment_prior`: representation=`objective_grounded_semantic`, algorithm=`imappo`
- `objective_profile_oracle`: representation=`structured_rule_context`, algorithm=`rule_planner`

## Intent generalization protocol

- Suite: `uav_intent_generalization_v3_strict_counterfactual`
- Training intents: `19`
