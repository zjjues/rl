# Result Card: uav_matd3_feasibility_v1

- Evidence level: `pilot`
- Seeds: `7, 11, 23, 42, 100`
- Evaluation episodes per seed/tier: `5`
- Primary objective: Estimate five-seed MATD3 performance under the same evaluation and hidden-task protocol as semantic residual pilot v2.
