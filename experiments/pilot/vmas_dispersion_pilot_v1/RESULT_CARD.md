# Result Card: vmas_dispersion_pilot_v1

- Evidence level: `pilot`
- Seeds: `7, 11, 23, 42, 100`
- Evaluation episodes per seed/tier: `10`
- Primary objective: Estimate five-seed optimizer stability on the public VMAS dispersion cooperative continuous-control scenario; no language claim.
