# Result Card: vmas_dispersion_architecture_v1_calibration

- Evidence level: `pilot`
- Seeds: `7`
- Evaluation episodes per seed/tier: `20`
- Primary objective: 100-training-episode runtime and variance calibration for the architecture-only VMAS dispersion paper protocol; not an effect study.
