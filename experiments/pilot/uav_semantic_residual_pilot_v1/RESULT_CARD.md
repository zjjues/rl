# Result Card: uav_semantic_residual_pilot_v1

- Evidence level: `pilot`
- Seeds: `7, 11, 23, 42, 100`
- Evaluation episodes per seed/tier: `5`
- Primary objective: Estimate whether semantic residual learning improves over the same nonsemantic residual and rule-only navigation prior without sacrificing safety.
