# Result Card: uav_semantic_residual_multimetric_pilot_v3

- Evidence level: `pilot`
- Seeds: `7, 11, 23, 42, 100`
- Evaluation episodes per seed/tier: `5`
- Primary objective: Pre-register and estimate safety, task, energy, distance, time, and separation intent-to-behavior alignment before a paper-level run.
