# Result Card: uav_rule_planner_feasibility_v1

- Evidence level: `pilot`
- Seeds: `7, 11, 23, 42, 100`
- Evaluation episodes per seed/tier: `5`
- Primary objective: Evaluate the deterministic target-tracking and potential-field planner on the same seeds and intent queries as learned feasibility baselines.
