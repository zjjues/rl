# Result Card: uav_qp_cbf_pilot_v1

- Evidence level: `pilot`
- Seeds: `7, 11, 23, 42, 100`
- Evaluation episodes per seed/tier: `10`
- Primary objective: Compare no filter, finite cyclic projection, and box-constrained QP-CBF under matched dense-risk scenarios.
...
- `rule_no_filter`: representation=`structured_rule_context`, algorithm=`rule_planner`
